...
## Todo App using express and mongo and node

Make sure you have node installed ou your machine. Once downloaded extract file to directory of you choice, cd into that dir and enter the command
...
npm run watch:all // runs npm-run-all -p devstart watch:css pushes changes in scss to public
```
